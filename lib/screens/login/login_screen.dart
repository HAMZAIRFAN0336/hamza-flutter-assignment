...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _validate() {
    setState(() {
      ...
      _passwordError = Validators.validateEmpty(_passwordController.text, fieldName: 'Password');
      _loginError = null;
    });
  }
  ...
  Future<void> _submit() async {
    ...
    final user = AuthController.instance.login(
                ...
                children: [
                  Center(
                    child: CircleAvatar(
                      ...
                      child: Icon(Icons.lock_outline, size: 30, color: colorScheme.onPrimaryContainer),
                    ),
                  ),
                  ...
                  if (_loginError != null) ...[
                    ...
                    Text(_loginError!, style: TextStyle(color: colorScheme.error)),
                  ],
                  Row(
                    children: [
                      Checkbox(
